...
public:
	...
	clsDate(string sDate)
	{
		...
		vector <string> vDate;
		vDate = clsString::SplitToVector(sDate, "/");
	...
	clsDate(short Seconds, short Mintues, short Hours , short Day, short Month, short Year) {
	...
	static string GetSystemDateTimeString() {
		...
		return (clsDate::DateToString(Date)) + " - " + (clsDate::ClockToString(Date));
	...
	static string ClockToString(clsDate Date) {
